# -*- coding: utf-8 -*-
"""
Created on Tue Mar 31 11:30:49 2020
...
input_texts = []
target_texts = []
for line in open("C:/My_projects/NLG/Prayers_hindu.txt"):
  line = line.rstrip()
  if not line:
    continue
...
with open(f'D:/Data science/NLP_learnings/deep learning NLP/DEEP_NLP_resources/data/GloVe/glove.6B/glove.6B.100d.txt', 'rb') as f:
...
np.savetxt("C:/My_projects/NLG/matrix_embedding.csv", embedding_matrix, delimiter=",")
